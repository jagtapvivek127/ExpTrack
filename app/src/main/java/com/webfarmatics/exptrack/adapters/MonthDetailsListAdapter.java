...
public class MonthDetailsListAdapter extends BaseAdapter {

    private Context context;
    private ArrayList<BeanStatesByDateHelper> statesByDateList;

    public MonthDetailsListAdapter(Context context, ArrayList<BeanStatesByDateHelper> statesByDateList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) { // if it's not recycled, initialize some
            ...
            viewOne = inflater.inflate(R.layout.month_details_single_row, parent, false);
        }

        BeanStatesByDateHelper helper = statesByDateList.get(position);
