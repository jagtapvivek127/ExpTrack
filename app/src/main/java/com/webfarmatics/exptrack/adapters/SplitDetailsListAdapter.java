...
public class SplitDetailsListAdapter extends BaseAdapter {
    private Context context;
    private ArrayList<BeanSplitHelperHelper> listHelper;


    public SplitDetailsListAdapter(Context context, ArrayList<BeanSplitHelperHelper> listHelper) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) { // if it's not recycled, initialize some
            ...
            viewOne = inflater.inflate(R.layout.split_details_single_row, parent, false);
        }
